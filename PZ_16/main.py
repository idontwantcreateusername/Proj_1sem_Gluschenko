...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.tree.column('ttl', width=120, anchor=tk.CENTER)
...
if __name__ == "__main__":
    ...
    app = Main(root)
    app.pack()
    root.title("Финтех на минималках(БАНК)")
    root.geometry("1080x450+300+200")
